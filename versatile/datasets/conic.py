...
class CoNICDataset(Dataset):
    """PyTorch Dataset class for loading images from CoNIC dataset"""

    def __init__(self, imgs, labels=None, dtm=None, indices=None, stain_aug=None, transforms=None, sc_loss=False):
        """
        Args:
        ...
        if labels is not None:
            # note labels[indices,:,:,:1] contains class labels
